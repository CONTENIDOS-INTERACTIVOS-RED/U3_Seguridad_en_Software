        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda las pruebas de seguridad en software, destacando la importancia de detectar vulnerabilidades antes de que sean explotadas. Se exploran las pruebas de penetración (pentesting), herramientas como OWASP ZAP y la simulación de ataques, promoviendo prácticas éticas y legales. Se enseña a identificar fallos, explotar debilidades, y proponer mejoras defensivas. Se emplean herramientas automatizadas y entornos seguros como Kali Linux y Metasploitable para ejecutar pruebas realistas. El enfoque busca preparar a los estudiantes para realizar evaluaciones ofensivas controladas, fortaleciendo su perfil profesional en ciberseguridad.
